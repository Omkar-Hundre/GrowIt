...
document.addEventListener('DOMContentLoaded', () => {
    ...
    menuIcon.addEventListener('click', () => {
        ...
        }, 10); // Small delay to allow CSS to apply the transition
    ...
    closeIcon.addEventListener('click', () => {
        ...
        }, 500); // Match this with the duration of the transition in CSS
...
document.getElementById("banner-button").onclick = function() {
    const bannerHeight = document.getElementById("slider").offsetHeight;
    window.scrollTo({
...
cards.forEach((card, index) => {
  gsap.fromTo(card, 
    {
      opacity: 0,
      x: index % 2 === 0 ? -300 : 300, // Slide in from left for even cards and right for odd cards
      y: index % 2 === 0 ? -100 : 100, // Slight vertical movement
    },
    {
      opacity: 1,
      x: 0,
      ...
      scrollTrigger: {
        trigger: card,
        start: "90% 85%", // Start the animation earlier
        end: "top 50%",
        scrub: true,
        toggleActions: "play reverse play reverse", // Keeps animation consistent in both directions
...
// Different settings for mobile view
  ...
  cards.forEach((card, index) => {
    gsap.fromTo(card, 
      ...
      },
      {
        ...
        scrollTrigger: {
          trigger: card,
          start: "100% 90%", // Earlier start for mobile
          end: "top 50%",
          scrub: true,
